...
class SubscriptionController extends Controller
{
    public function index()
    {
        ...
        return view('app.billing.subscriptions.index', compact('subscriptions'));
    }
    ...
    public function create()
    {
        ...
        return view('app.billing.subscriptions.form', compact('subscription'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('app.billing.subscriptions.index')
